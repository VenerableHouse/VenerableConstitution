...
\title{Ruddock House Constitution}
\author{}
...
\item The order of succession shall be President, Vice-president, Secretary, Treasurer, Social Chairman, Athletic Manager, and Librarian.
...
\item The House Aluminati shall maintain all kitchen areas, kitchen appliances, kitchen related supplies, and the hot tub; they shall also maintain a regular supply of soft drinks for the House and be responsible for the recycling of the House’s aluminum, plastic, glass, and other material of recycling value.
\end{enumerate}
\subsection{Nominations, Elections, and Appointments}
\begin{enumerate}
\item Nominations for ARC representative, CRC representative, two BoC representatives, Librarian, Athletic Manager, Social Chairman, Treasurer, Secretary, Vice-president, and President, in that order, shall be made at a meeting of the House held for that purpose between the beginning of the second term and the third Friday of second term. Nominations shall remain open until the election of that office.
\item Election of all officers shall be carried out at a House Meeting held for that purpose within two weeks after the nomination meeting. The order of election shall be in reverse order of nomination. The election for each office shall be held before nominations for successive offices are closed. Election shall require a majority of votes cast from the total voting membership, not including blank ballots, and they shall be made by secret ballot. Votes shall be counted by senior class members, and runoffs and recounts shall be held at the discretion of those senior members tabulating the ballots.
...
\subsection{Membership}
The Executive Committee shall consist of the President, who shall act as chairman, the Vice-president, Social Chairman, Secretary, Treasurer, Athletic Manager, and Librarian.
\subsection{Voting}
...
\item The Secretary shall be present to record minutes at all meetings.
...
\begin{enumerate}
\item In order of preference, House President, House Vice President, House Secretary, House Treasurer, House Social Team (up to three members), Athletic Managers (up to two members), Librarian, UCCs (one member per alley), IHC Chairman, ASCIT President, BoC Chair, House-elected BoC Representatives (up to two members), O’Domhnaill’s Suppliers (up to two members), Aluminati (up to two members), House Head Waiter (one member), House BFD editors (one member),House Historians (one member)
...
An amendment to this Constitution passes if 1/2 of the eligible voters cast votes in favor of the amendment.
\subsection{Procedure}
\begin{enumerate}
